...
describe('Noteful API - Notes', function () {
  ...
  describe('GET /api/notes', function () {
    ...
    it('should return correct search results for a searchTerm query', function () {
      ...
      const dbPromise = Note.find({title: { $regex: searchTerm, $options: 'i' },
        userId: user.id
    ...
    it('should return correct search results for a tagId query', function () {
      let data;
      return Tag.find({ userId: user.id }).limit(1)
        .then((_data) => {
          data = _data[0];
          return Promise.all([
    ...
    it('should return correct notes', function () {
      ...
      return Note.find({ userId: user.id }).limit(1)
        ...
        .then((res) => {
          ...
          expect(res.body).to.have.all.keys('id', 'title', 'userId', 'content', 'createdAt', 'updatedAt', 'folderId', 'tags');
